   ...
   public class Game : Microsoft.Xna.Framework.Game
{
    ...
    public Game()
    {
        ...
        selectedOption = 0;
        messageHandler = new MessageHandler(playersDict, GraphicsDevice, creatureOptions, selectedOption);
    }
    ...
    protected override void LoadContent()
    {
        ...
        menuFont = Content.Load<SpriteFont>("Fonts/MenuFont"); // Ensure this path matches your content structure
    }
